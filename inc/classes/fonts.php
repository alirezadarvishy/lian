 ...
 * Lian fonts.
 *
 * Lian fonts handler class is responsible for registering the supported
 * fonts used by Lian.
 *
 * @since 1.0.0
 */
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => esc_html__( 'System', 'lian' ),
			];

            $font_groups = array_merge( $font_groups, [
                self::GOOGLE => esc_html__( 'Google', 'lian' ),
                self::EARLYACCESS => esc_html__( 'Google (Early Access)', 'lian' ),
            ] );
		}
